...
async def help(ctx):
    ...
    # Footer
    embed.set_footer(text="Developed by GeoFS Flights Channel | Use !mod_help for First Officer commands")
...
async def mod_help(ctx):
    ...
    # Footer
    embed.set_footer(text="First Officer Commands | Use !admin_help for Captain-only commands")
