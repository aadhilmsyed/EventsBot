...
class TestHelpUtilities:
    ...
    def test_command_availability_logic(self):
        ...
        economy_roles = [int(os.getenv('ECONOMY_CLASS_ROLE_ID'))]
        ...
        # Test premium economy user
        premium_roles = [int(os.getenv('PREMIUM_ECONOMY_ROLE_ID'))]
        ...
        # Test business class user
        business_roles = [int(os.getenv('BUSINESS_CLASS_ROLE_ID'))]
        ...
        # Test first class user
        first_class_roles = [int(os.getenv('FIRST_CLASS_ROLE_ID'))]
    ...
    def test_mod_help_permission_logic(self):
        ...
        first_officer_roles = [int(os.getenv('FIRST_OFFICER_ROLE_ID'))]
        assert can_access_mod_help(first_officer_roles) == True
        
        # Test captain access
        captain_roles = [int(os.getenv('CAPTAIN_ROLE_ID'))]
        assert can_access_mod_help(captain_roles) == True
        
        # Test insufficient access
        other_roles = [int(os.getenv('FIRST_CLASS_ROLE_ID'))]  # First class
    ...
    def test_admin_help_permission_logic(self):
        ...
        # Test insufficient access
        other_roles = [int(os.getenv('FIRST_OFFICER_ROLE_ID'))]  # First officer
