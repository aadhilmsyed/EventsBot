...
class TestMetarUtilities:
    ...
    def test_metar_data_parsing_logic(self):
        ...
        def parse_metar_data(metar_string):
            ...
            for part in parts:
                ...
                elif part.startswith("BKN") or part.startswith("OVC") or part.startswith("SCT"):  # Clouds
    ...
    def test_data_formatting_logic(self):
        ...
        metar_data = {
            "airport": "KSFO",
            "raw": "KSFO 121156Z 28012KT 10SM BKN250"
        }
        ...
        atis_data = {
            "raw": "ATIS INFORMATION KILO. WIND 280 AT 12."
        }
