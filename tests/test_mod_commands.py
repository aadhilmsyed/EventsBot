...
class TestModCommandUtilities:
    ...
    def test_channel_management_logic(self):
        ...
        restricted_channels = [int(os.getenv('LOG_CHANNEL_ID')), int(os.getenv('MESSAGE_LOGS_CHANNEL_ID'))]  # LOG_CHANNEL_ID, MESSAGE_LOGS_CHANNEL_ID
        new_channel_id = int(os.getenv('MEMBER_LOGS_CHANNEL_ID'))  # MEMBER_LOGS_CHANNEL_ID
        ...
        existing_channel_id = int(os.getenv('LOG_CHANNEL_ID'))  # LOG_CHANNEL_ID (already in list)
